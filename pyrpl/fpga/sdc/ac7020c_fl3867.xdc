...
set_property PACKAGE_PIN Y17     [get_ports {adc_dat_a_i[4]}]
set_property PACKAGE_PIN Y16     [get_ports {adc_dat_a_i[5]}]
set_property PACKAGE_PIN V15     [get_ports {adc_dat_a_i[6]}]
set_property PACKAGE_PIN Y18     [get_ports {adc_dat_b_i[7]}]
set_property PACKAGE_PIN W16     [get_ports {adc_dat_a_i[8]}]
set_property PACKAGE_PIN V16     [get_ports {adc_dat_a_i[9]}]
set_property PACKAGE_PIN W20     [get_ports {adc_dat_a_i[10]}]
set_property PACKAGE_PIN V20     [get_ports {adc_dat_a_i[11]}]
set_property PACKAGE_PIN W15     [get_ports {adc_dat_a_i[12]}]
set_property PACKAGE_PIN Y19     [get_ports {adc_dat_a_i[13]}]
set_property PACKAGE_PIN W19     [get_ports {adc_dat_a_i[14]}]
set_property PACKAGE_PIN W18     [get_ports {adc_dat_a_i[15]}]

# ADC B data
set_property IOSTANDARD LVCMOS18 [get_ports {adc_dat_b_i[*]}]
set_property IOB        TRUE     [get_ports {adc_dat_b_i[*]}]
set_property PACKAGE_PIN U12     [get_ports {adc_dat_b_i[4]}]
set_property PACKAGE_PIN T12     [get_ports {adc_dat_b_i[5]}]
set_property PACKAGE_PIN W13     [get_ports {adc_dat_b_i[6]}]
set_property PACKAGE_PIN V12     [get_ports {adc_dat_b_i[7]}]
set_property PACKAGE_PIN T10     [get_ports {adc_dat_b_i[8]}]
set_property PACKAGE_PIN T11     [get_ports {adc_dat_b_i[9]}]
set_property PACKAGE_PIN W14     [get_ports {adc_dat_b_i[10]}]
set_property PACKAGE_PIN Y14     [get_ports {adc_dat_b_i[11]}]
set_property PACKAGE_PIN T14     [get_ports {adc_dat_b_i[12]}]
set_property PACKAGE_PIN T15     [get_ports {adc_dat_b_i[13]}]
set_property PACKAGE_PIN R14     [get_ports {adc_dat_b_i[14]}]
set_property PACKAGE_PIN P14     [get_ports {adc_dat_b_i[15]}]
