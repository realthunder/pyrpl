...
create_project -force tb_fft_native_multi $origin/proj_multi -part $part
...
# Testbench
add_files -fileset sim_1 -norecurse $origin/tb_fft_native_multi.sv
set_property top tb_fft_native_multi [get_filesets sim_1]
