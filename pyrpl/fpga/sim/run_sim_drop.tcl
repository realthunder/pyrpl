...
create_project -force tb_fft_native_drop $origin/proj_drop -part $part
...
# Testbench
add_files -fileset sim_1 -norecurse $origin/tb_fft_native_drop.sv
set_property top tb_fft_native_drop [get_filesets sim_1]
