...
create_project -force tb_fft_native_badframe $origin/proj_badframe -part $part
...
# Testbench
add_files -fileset sim_1 -norecurse $origin/tb_fft_native_badframe.sv
set_property top tb_fft_native_badframe [get_filesets sim_1]
