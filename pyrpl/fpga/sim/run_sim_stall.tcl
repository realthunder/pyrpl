...
create_project -force tb_fft_native_stall $origin/proj_stall -part $part
...
# Testbench
add_files -fileset sim_1 -norecurse $origin/tb_fft_native_stall.sv
set_property top tb_fft_native_stall [get_filesets sim_1]
