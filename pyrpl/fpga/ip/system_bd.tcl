...
if { [string first $scripts_vivado_version $current_vivado_version] == -1 } {
   puts "INFO: Script was generated with Vivado $scripts_vivado_version; running in $current_vivado_version (IPs will be auto-upgraded)."
}
...
CONFIG.FREQ_HZ {125000000} \
  ...
  set S_AXI_HP2_aclk [ create_bd_port -dir I -type clk S_AXI_HP2_aclk ]
  set_property -dict [ list \
CONFIG.FREQ_HZ {125000000} \
 ] $S_AXI_HP2_aclk
...
CONFIG.PCW_USE_S_AXI_HP2 {1} \
  ...
  connect_bd_net -net processing_system7_0_fclk_clk3 [get_bd_ports FCLK_CLK3] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7/FCLK_CLK3] [get_bd_pins processing_system7/M_AXI_GP1_ACLK]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces S_AXI_HP2] [get_bd_addr_segs processing_system7/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
