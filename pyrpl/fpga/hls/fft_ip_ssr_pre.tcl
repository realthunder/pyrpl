...
# NOTE: config_compile -pipeline_style frp tried — no effect (rewind/ap_ctrl_none
# dataflow makes these pipelines non-flushable; forcing frp risks deadlock, see
# the 200-656 warnings in the fft_ssr solution). Left on default (stp).
