...
if (dac_rstn_i == 1'b0) begin
   ...
   if (sys_wen) begin
      ...
      if (sys_addr[19:0]==20'h50)   {rand_c_on, at_autorearm_c, at_invert_c, at_reset_c, set_c_rgate, set_c_zero, set_c_rst, set_c_once, set_c_wrap} <= sys_wdata[12: 4] ;
      if (sys_addr[19:0]==20'h50)   {rand_d_on, at_autorearm_d, at_invert_d, at_reset_d, set_d_rgate, set_d_zero, set_d_rst, set_d_once, set_d_wrap} <= sys_wdata[28:20] ;
...
wire [32-1: 0] r1_rd = {3'h0,rand_d_on,at_autorearm_d,at_invert_d,at_reset_d,set_d_rgate, set_d_zero,set_d_rst,set_d_once,set_d_wrap, 1'b0,trig_d_src,
                        3'h0,rand_c_on,at_autorearm_c,at_invert_c,at_reset_c,set_c_rgate, set_c_zero,set_c_rst,set_c_once,set_c_wrap, 1'b0,trig_c_src };
